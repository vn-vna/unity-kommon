...
{
    [CreateAssetMenu(
        fileName = "LocalAchievementProvider",
        menuName = "Scheherazade/Achievement/Local Achievement Provider")]
    public class LocalAchievementProvider : ScriptableObject, IAchievementProvider
    {
            ...
            CancellationToken ct = default)
        {
            ...
            bool isUnlocked = clamped >= FullProgress;
        ...
        private static double ClampProgress(double progress)
        {
            ...
            if (progress > FullProgress) return FullProgress;
            return progress;
        }
        ...
        private AchievementState LoadState(string achievementId)
        {
            ...
            if (!File.Exists(path))
            {
                return new AchievementState(
                    achievementId, false, 0.0, 0, null, null);
            }
