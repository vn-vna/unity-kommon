...
using UnityEditor;
using UnityEngine;
namespace Com.Hapiga.Scheherazade.Common.Editor.Integration
{
    public class CreateResourceManagerWindow : EditorWindow
    {
        ...
        private string BuildScriptContent()
        {
            ...
            sb.AppendLine("using Com.Hapiga.Scheherazade.Common.Integration;");
            ...
            sb.AppendLine($"{indent}    : ResourceManagerBase<{_className}, {resourceType}>");
