...
namespace Com.Hapiga.Scheherazade.Common.Frameworks.GridSystem
{
    ...
    public class GridOccupant : IGridOccupant
    {
        ...
        public GridCoord? GetRelativePositionOnPlaceableGrid(GridCell cell, bool forceInside = false)
        {
        ...
        public GridCoord GetRelativePositionToHookedCell(GridCell cell)
            => HookedCell == null ? GridCoord.zero : HookedCell.GridPosition - cell.GridPosition;

        public virtual bool CheckReplaceableBy(IGridOccupant other, GridCell cell, GridCoord relativePosition)
            => false;
